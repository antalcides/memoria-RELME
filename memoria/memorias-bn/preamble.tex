...
\fancypagestyle{headings}{%
  ...
  \fancyhead[LE]{%
    ...
    \color{aurometalsaurus}\sffamily\itshape\small\protect\nouppercase{Vig\'esima Octava Reuni\'on Latinoamericana de Matem\'aticas Educativa}\ 
  ...
  \fancyfoot[RO,LE]{\tikz[baseline]\node[pagefooter]{\thepage};}
   \fancyfoot[CO,CE]{\tikz\node{\color{aurometalsaurus}Barranquilla - Colombia};}
...
\titleformat{\section}{\normalfont\footnotesize\sf}{\titlebar}{0.25cm}{\textcolor{aurometalsaurus}{#1}}      %% Change color if needed and remove \sf.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\salon}[2][302H]{  \bf \textcolor{ptctitle}{\uppercase{Sal\'on\ #1}} \ \bfseries\sffamily \textcolor{ptctitle}{#2:}}
